...
contract AEROPriceFeed is TokenPriceFeedBase {
    ...
    function fetchRedemptionPrice() external returns (uint256, bool) {
        // Use same price for redemption as all other ops in AERO branch
        return fetchPrice();
    }
    ...
    function _fetchPricePrimary() internal returns (uint256, bool) {
        ...
        // If the AERO-USD Chainlink response was invalid in this transaction, return the last good AERO-USD price calculated
