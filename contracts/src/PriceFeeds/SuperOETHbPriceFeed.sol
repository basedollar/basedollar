...
contract SuperOETHbPriceFeed is TokenPriceFeedBase {
    constructor(address _owner, address _superOETHbUsdOracleAddress, uint256 _superOETHbUsdStalenessThreshold)
        TokenPriceFeedBase(_owner, _superOETHbUsdOracleAddress, _superOETHbUsdStalenessThreshold)
    {
        _fetchPricePrimary();
    ...
    function fetchRedemptionPrice() external returns (uint256, bool) {
        // Use same price for redemption as all other ops in superOETHb branch
        return fetchPrice();
    }
    ...
    function _fetchPricePrimary() internal returns (uint256, bool) {
        ...
        // If the superOETHb-USD Chainlink response was invalid in this transaction, return the last good superOETHb-USD price calculated
