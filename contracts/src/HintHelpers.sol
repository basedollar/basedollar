...
contract HintHelpers is IHintHelpers {
    ...
    */
    ...
    //=============================================================
    //                   Non Redeemable Branches Helpers          |
    //=============================================================

    function getApproxHintNonRedeemable(uint256 _collIndex, uint256 _interestRate, uint256 _numTrials, uint256 _inputRandomSeed)
        external
        view
        returns (uint256 hintId, uint256 diff, uint256 latestRandomSeed)
    {
    ...
    function predictAdjustInterestRateUpfrontFeeNonRedeemable(uint256 _collIndex, uint256 _troveId, uint256 _newInterestRate)
        external
        view
        returns (uint256)
    {
    ...
    function forcePredictAdjustInterestRateUpfrontFeeNonRedeemable(uint256 _collIndex, uint256 _troveId, uint256 _newInterestRate)
        external
        view
        returns (uint256)
    {
    ...
    function predictAdjustBatchInterestRateUpfrontFeeNonRedeemable(
        uint256 _collIndex,
        address _batchAddress,
        uint256 _newInterestRate
    ) external view returns (uint256) {
    ...
    function predictOpenTroveAndJoinBatchUpfrontFeeNonRedeemable(uint256 _collIndex, uint256 _borrowedAmount, address _batchAddress)
        external
        view
        returns (uint256)
    {
    ...
    function predictJoinBatchInterestRateUpfrontFeeNonRedeemable(uint256 _collIndex, uint256 _troveId, address _batchAddress)
        external
        view
        returns (uint256)
    {
    ...
    function predictRemoveFromBatchUpfrontFeeNonRedeemable(uint256 _collIndex, uint256 _troveId, uint256 _newInterestRate)
        external
        view
        returns (uint256)
    {
