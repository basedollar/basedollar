...
abstract contract SPInvariantsBase is Assertions, BaseInvariantTest {
    ...
    function setUp() public override {
        ...
        TestDeployer.LiquityContractsDev memory contracts = result.contracts;
        IBoldToken boldToken = result.boldToken;
        HintHelpers hintHelpers = result.hintHelpers;
    ...
    function assert_AllFundsClaimable() internal view {
        ...
        assertApproxEqAbsRelDecimal(yieldGainsOwed, sumYieldGains, 1 ether, 1_000, 18, "SP yield loss");
    }
}
