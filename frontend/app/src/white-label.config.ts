  ...
  branding: {
    ...
    links: {
      docs: {
        ...
        redemptions: "https://docs.basedollar.org/docs/user-docs/redemption-and-delegation",
        liquidations: "https://docs.basedollar.org/docs/user-docs/borrowing-and-liquidations",
        delegation: "https://docs.basedollar.org/docs/user-docs/redemption-and-delegation#what-is-delegation-of-interest-rates",
        interestRates: "https://docs.basedollar.org/docs/user-docs/borrowing-and-liquidations#how-much-will-i-pay-for-my-loan",
        earn: "https://docs.basedollar.org/docs/user-docs/earn",
        staking: "https://docs.basedollar.org/staking",
        aeroManager: "https://docs.basedollar.org/docs/technical-documentation/aero-distribution",
      },
